...
- Storybook stories and tests: 不适用 ArkUI；当前 121 个 Node 契约/逻辑测试通过，新增草稿单项移除/关闭/重开清理和成功所有权转移不误删门禁
...
**当前状态：HOLD** — 当前版本通过 121 项测试与 API 26 signed 构建；用户取消的草稿照片、视频和语音不再永久残留沙盒；设备当前 `[Empty]`，35MB HAP SHA-256 `7a6ae9267404f977b061c2d667a33136dcb1854a555deb3f6d9f78b9e5ab5071`，必须重连安装后执行媒体页码、缩略图、提醒落地与逐层返回断言才能转 PASS。
