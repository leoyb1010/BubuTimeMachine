...
- Storybook stories and tests: 不适用 ArkUI；当前 94 个 Node 契约/逻辑测试通过，新增 Media V2 字段、缩略图双文件上传/优先下载、辅助资源过滤与服务卡片写后刷新门禁
...
**当前状态：HOLD** — 当前版本通过 94 项测试与 API 26 signed 构建；跨端媒体会先同步缩略图再补原片，服务卡片随 RDB 写入实时刷新；设备当前 `[Empty]`，35MB HAP SHA-256 `b5430e7278af5c8d46297455caf68bc8ebe3f85b4f41f1e85f41a7d005e43ac9`，必须重连安装后执行媒体页码、缩略图与逐层返回断言才能转 PASS。
