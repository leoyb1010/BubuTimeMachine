...
- Storybook stories and tests: 不适用 ArkUI；当前 135 个 Node 契约/逻辑测试通过，新增 Share Kit 文本/超链接双记录、bubutime 深链冷启动/onNewWant 和缩略图存在性门禁
...
**当前状态：HOLD** — 当前版本通过 135 项测试与 API 26 signed 构建；Share Kit 已覆盖文件、文本和目标 Entry 直达；设备当前 `[Empty]`，35MB HAP SHA-256 `50bbd9e82b6bb1d1b2e9eb4e2d0034eb7c1be149fef37d633dfc53c51ee8a28f`，必须重连安装后执行媒体页码、深链、最大字号和逐层返回断言才能转 PASS。
