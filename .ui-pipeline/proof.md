...
- Storybook stories and tests: 不适用 ArkUI；当前 108 个 Node 契约/逻辑测试通过，新增家庭成员最后一人门禁、删除确认、当前身份 fallback、切换/编辑和无障碍动作门禁
...
**当前状态：HOLD** — 当前版本通过 108 项测试与 API 26 signed 构建；家庭成员删除不会破坏最后一人或当前身份，且支持切换和编辑；设备当前 `[Empty]`，35MB HAP SHA-256 `5e6c6e0ac4846c5cd4e4eb22d75b2a35fbb4eb6204134a585dc6a2dcb78cc02f`，必须重连安装后执行媒体页码、缩略图与逐层返回断言才能转 PASS。
