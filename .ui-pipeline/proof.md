...
- Storybook stories and tests: 不适用 ArkUI；当前 74 个 Node 契约/逻辑测试通过，覆盖媒体排序/初始索引、单一返回调度、首页同步重试、时光卡文案/封面比例与批量媒体查询
...
**当前状态：HOLD** — 当前版本通过 74 项测试、API 26 signed 构建和仓库卫生检查；设备当前 `[Empty]`，HAP SHA-256 `d3e5978b1e65eb2283ba1fda018c04deca60a507147277a22d250c054f690cc3`，必须重连后执行媒体页码与逐层返回断言才能转 PASS。
