...
- Storybook stories and tests: 不适用 ArkUI；当前 89 个 Node 契约/逻辑测试通过，新增恢复码 24 词/词表/v3 试解、胶囊 upsert 与临时语音门禁
...
**当前状态：HOLD** — 当前版本通过 89 项测试与 API 26 signed 构建；恢复码覆盖增加密码学校验，胶囊解封语音不再永久落 Media；设备当前 `[Empty]`，35MB HAP SHA-256 `52ba090eba55257200cad63baf8adf2bd46ba1c57d41edcdcd31e81a3bde17f6`，必须重连安装后执行媒体页码与逐层返回断言才能转 PASS。
