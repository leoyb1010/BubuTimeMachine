...
- Storybook stories and tests: 不适用 ArkUI；当前 103 个 Node 契约/逻辑测试通过，新增后台照片已授权扫描、禁止后台权限弹窗和前后台周报主动发现门禁
...
**当前状态：HOLD** — 当前版本通过 103 项测试与 API 26 signed 构建；后台任务会发现已授权的新照片和新周报，不依赖先打开对应页面；设备当前 `[Empty]`，35MB HAP SHA-256 `d5786b04da30900554061d745c33373b4c30dd505a94efd9b202b1bcf5aaa051`，必须重连安装后执行媒体页码、缩略图与逐层返回断言才能转 PASS。
