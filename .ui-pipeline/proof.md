...
- Storybook stories and tests: 不适用 ArkUI；当前 138 个 Node 契约/逻辑测试通过，新增 BTC2/BTC3 固定 nonce golden vector、独立 AES-GCM 解密和 Harmony 启动 CryptoFramework 自检
...
**当前状态：HOLD** — 当前版本通过 138 项测试与 API 26 signed 构建；BTC2/BTC3 跨端固定向量已进入三层自检；设备当前 `[Empty]`，35MB HAP SHA-256 `07b9c92d97ed9ec20e05a15ccfcc8da1d28f3dc6291bc11314ade3c0394e360d`，必须重连安装后执行媒体页码、胶囊恢复、深链和逐层返回断言才能转 PASS。
